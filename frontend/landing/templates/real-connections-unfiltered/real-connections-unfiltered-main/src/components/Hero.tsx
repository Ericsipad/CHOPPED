        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button size="lg" className="btn-hero text-xl px-12 py-6 shadow-glow">
                Sign Up Free
              </Button>
              <Button variant="outline" size="lg" className="btn-hero-outline text-xl px-12 py-6 bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white hover:text-foreground">
                Sign In
              </Button>
            </div>
