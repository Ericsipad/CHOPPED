...
const styles: Record<string, React.CSSProperties> = {
	...
	footer: { padding: '0 10px 12px', display: 'flex', justifyContent: 'flex-end' },
	closeBtn: { border: '1px solid rgba(255,255,255,0.15)', background: 'rgba(0,0,0,0.3)', color: '#fff', padding: '4px 10px', borderRadius: 8, cursor: 'pointer', fontSize: 13, marginLeft: 10 },
